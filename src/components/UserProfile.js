...
//material ui imports
import { createStyles, Grid, Avatar } from "@material-ui/core";
...
function UserProfile() {
    ...
    let name = useSelector((state) => state.auth.userName)

    let { posts, profile } = useFetchCurrentUserContent(name)
    ...
    return (
        <div className="profilePage">
            ...
            <section className='userProfile'>                
                <Avatar className={classes.large} src='' alt={name} />                
                <div className="userData">
                    <div className="userAccount">
                        <div className="userName">{ profile !== {} ? profile.name : (<p>UserName</p>)}</div>
                        <button className="editProfile" onClick={()=> history.push(`/`)}>Edit Profile</button>
                        <svg
